...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->string('refund_status')->default(\App\Enums\OrderRefundStatusEnum::REFUND_STATUS_PENDING)->comment('退款状态');
            ...
            $table->string('ship_status')->default(\App\Enums\OrderShipStatusEnum::SHIP_STATUS_PENDING)->comment('物流状态');
